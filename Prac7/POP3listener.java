...
public class POP3listener {
    ...
    public POP3listener(String host, String userName, String password,int port) { // Constructor for POP 3 listener and sets a few key properties
    ...
    protected void checkForError(String response) throws IOException { //Throws exception if given server response if negative. According to POP3
        if (response.charAt(0) != '+')    //protocol, positive responses start with a '+' and negative start with '-'
